...
/*package*/ class DepositWellRow_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DepositWellRow_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_9kzc7j_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_9kzc7j_a");
  ...
  public Grid createStaticHorizontal_9kzc7j_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(3);
    if (true) {
      children.add(createTableCell_9kzc7j_a0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_9kzc7j_b0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_9kzc7j_c0a(editorContext, node));
    }
  ...
  public Grid createTableCell_9kzc7j_a0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createHeaderReference_9kzc7j_a0a0(editorContext, node));
  ...
  public HeaderGrid createHeaderReference_9kzc7j_a0a0(final EditorContext editorContext, final SNode snode) {
    HeaderGrid hgrid = new HeaderGrid();
    hgrid.setElement(0, 0, new StringHeaderReference("Prueba1"));
    return hgrid;
  }
  public Grid createTableCell_9kzc7j_b0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createHeaderReference_9kzc7j_a1a0(editorContext, node));
  ...
  public HeaderGrid createHeaderReference_9kzc7j_a1a0(final EditorContext editorContext, final SNode snode) {
    HeaderGrid hgrid = new HeaderGrid();
    hgrid.setElement(0, 0, new StringHeaderReference("prueba2"));
    return hgrid;
  }
  public Grid createTableCell_9kzc7j_c0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createHeaderReference_9kzc7j_a2a0(editorContext, node));
  ...
  private EditorCell createRefCell_2() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder2(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.depositWell$Yx_L);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
        installDeleteActions_notnull_smartReference(cell);
        return cell;
  ...
  public HeaderGrid createHeaderReference_9kzc7j_a2a0(final EditorContext editorContext, final SNode snode) {
    HeaderGrid hgrid = new HeaderGrid();
    hgrid.setElement(0, 0, new StringHeaderReference("prueba3"));
    return hgrid;
  }
