...
/*package*/ class MultilateralWell_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MultilateralWell_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_8re5b4_a");
  ...
  private EditorCell createProperty_5() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.branches$jVHw;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no branches>");
      editorCell.setCellId("property_branches");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(new IAttributeDescriptor.AllAttributes().list(myNode), CONCEPTS.PropertyAttribute$Gb);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where((it) -> Objects.equals(PropertyAttribute__BehaviorDescriptor.getProperty_id1avfQ4BBzOo.invoke(it), property));
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_8re5b4_g0");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ReseirvorSingleRoleHandler_8re5b4_h0(myNode, LINKS.Reseirvor$u$Zd, getEditorContext());
    return provider.createCell();
  }
  private static class ReseirvorSingleRoleHandler_8re5b4_h0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ReseirvorSingleRoleHandler_8re5b4_h0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_8re5b4_i0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new DrillingOperationSingleRoleHandler_8re5b4_j0(myNode, LINKS.DrillingOperation$K00Q, getEditorContext());
    return provider.createCell();
  }
  private static class DrillingOperationSingleRoleHandler_8re5b4_j0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public DrillingOperationSingleRoleHandler_8re5b4_j0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_8re5b4_k0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new CoordinatesSingleRoleHandler_8re5b4_l0(myNode, LINKS.Coordinates$JU9t, getEditorContext());
    return provider.createCell();
  }
  private static class CoordinatesSingleRoleHandler_8re5b4_l0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public CoordinatesSingleRoleHandler_8re5b4_l0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_8re5b4_m0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_3() {
    SingleRoleCellProvider provider = new WellHeadTypeSingleRoleHandler_8re5b4_n0(myNode, LINKS.WellHeadType$JTFr, getEditorContext());
    return provider.createCell();
  }
  private static class WellHeadTypeSingleRoleHandler_8re5b4_n0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public WellHeadTypeSingleRoleHandler_8re5b4_n0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty branches$jVHw = MetaAdapterFactory.getProperty(0x70d970ca2bc64a80L, 0xa08c12893f37926cL, 0x2fba2edb9936202eL, 0x740a9055b2063625L, "branches");
  }
