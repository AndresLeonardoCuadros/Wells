...
/*package*/ class DepositWell_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_5() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.depthPressure$tTE8;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createProperty_6() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.temperaturePressure$tUPd;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_x0teg0_h0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ReseirvorSingleRoleHandler_x0teg0_i0(myNode, LINKS.Reseirvor$u$Zd, getEditorContext());
    return provider.createCell();
  }
  private static class ReseirvorSingleRoleHandler_x0teg0_i0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ReseirvorSingleRoleHandler_x0teg0_i0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_x0teg0_j0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new DrillingOperationSingleRoleHandler_x0teg0_k0(myNode, LINKS.DrillingOperation$K00Q, getEditorContext());
    return provider.createCell();
  }
  private static class DrillingOperationSingleRoleHandler_x0teg0_k0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public DrillingOperationSingleRoleHandler_x0teg0_k0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_x0teg0_l0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new CoordinatesSingleRoleHandler_x0teg0_m0(myNode, LINKS.Coordinates$JU9t, getEditorContext());
    return provider.createCell();
  }
  private static class CoordinatesSingleRoleHandler_x0teg0_m0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public CoordinatesSingleRoleHandler_x0teg0_m0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_x0teg0_n0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_3() {
    SingleRoleCellProvider provider = new WellHeadTypeSingleRoleHandler_x0teg0_o0(myNode, LINKS.WellHeadType$JTFr, getEditorContext());
    return provider.createCell();
  }
  private static class WellHeadTypeSingleRoleHandler_x0teg0_o0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public WellHeadTypeSingleRoleHandler_x0teg0_o0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty depthPressure$tTE8 = MetaAdapterFactory.getProperty(0x70d970ca2bc64a80L, 0xa08c12893f37926cL, 0x740a9055b2063623L, 0x740a9055b2063636L, "depthPressure");
    /*package*/ static final SProperty temperaturePressure$tUPd = MetaAdapterFactory.getProperty(0x70d970ca2bc64a80L, 0xa08c12893f37926cL, 0x740a9055b2063623L, 0x740a9055b206363bL, "temperaturePressure");
  }
